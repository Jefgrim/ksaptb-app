...
import {
  ...
  CheckCircle2, QrCode as QrIcon, ArrowRight, AlertTriangle, RefreshCcw, ExternalLink, FileText
} from "lucide-react";
                      ...
                      {booking.adminRefundProofUrl && (
                        <div>
                          ...
                          <div className="mt-2 border rounded-lg overflow-hidden relative h-48 w-full bg-slate-50">
                            <Image src={booking.adminRefundProofUrl} alt="Proof" layout="fill" className="object-contain w-full h-full" />
                          </div>
                          <a href={booking.adminRefundProofUrl} target="_blank" rel="noreferrer">
