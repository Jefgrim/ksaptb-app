...
export function TourList() {
  // ADMIN still sees 'list' (all tours)
  ...
  const openEdit = (tour: any) => {
    ...
    // CONVERT STORED TIMESTAMP BACK TO KSA DATE STRING (YYYY-MM-DD)
    // This ensures the date picker shows the correct date when editing
